...
class Keypair {
    ...
    _generatePrivateKey() {
        ...
        this.privKey = new BaseKey(encodeKey(genKey(shb)), Xhint.PRIVATE_KEY);
    }
};
...
const getNewKeypair = () => {
    return getKeypairFromPrivateKey(encodeKey(ec.genKeyPair().getPrivate('hex')) + Xhint.PRIVATE_KEY);
}
