...
const { BlockSignItem, BLOCKSIGN_CREATE_DOCUMENTS, BLOCKSIGN_SIGN_DOCUMENTS, BLOCKSIGN_TRANSFER_DOCUMENTS } = require('./base');

const { MBS_CREATE_DOCUMENTS_SINGLE_FILE, MBS_SIGN_ITEM_SINGLE_DOCUMENT, MBS_TRANSFER_ITEM_SINGLE_DOCUMENT, 
    MBS_CREATE_DOCUMENTS_OP_FACT, MBS_TRANSFER_DOCUMENTS_OP_FACT, MBS_SIGN_DOCUMENTS_OP_FACT } = require('./hint');
const { CreateDocumentsItem, SignDocumentsItem, TransferDocumentsItem } = require('./item');
...
class BlockSignGenerator extends OperationGenerator {
     ...
     * @param {number} did Document ID
     * @param {string} cid Currency ID
     * @returns {TransferDocumentsItem} TransferDocumentsItem
     */
    createTransferDocumentsItem(owner, receiver, did, cid) {
        return new TransferDocumentsItem(
            MBS_TRANSFER_ITEM_SINGLE_DOCUMENT,
            owner,
            receiver,
            did,
            cid
    ...
    createBlockSignFact(type, sender, items) {
        ...
        switch (type) {
            ...
            case BLOCKSIGN_SIGN_DOCUMENTS:
                ...
                break;
            case BLOCKSIGN_TRANSFER_DOCUMENTS:
