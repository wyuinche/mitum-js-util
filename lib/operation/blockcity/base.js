...
const { MBC_DOCUMENT_INFO, MBC_VOTING_CANDIDATE, MBC_USER_STATISTICS, MBC_DOCTYPE_USER_DATA, MBC_USER_DOCUMENT_ID, MBC_DOCTYPE_LAND_DATA, MBC_LAND_DOCUMENT_ID, MBC_DOCTYPE_VOTE_DATA, MBC_VOTE_DOCUMENT_ID, MBC_DOCTYPE_HISTORY_DATA, MBC_HISTORY_DOCUMENT_ID } = require("../../hint");
...
class Candidate {
    constructor(address, nickname, manifest) {
    ...
    buffer() {
        ...
        return Buffer.concat([bAddress, bNickname, bManifest]);
    }
