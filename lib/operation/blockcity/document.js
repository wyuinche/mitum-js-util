...
const { MBC_DOCTYPE_LAND_DATA, MBC_DOCTYPE_USER_DATA, MBC_DOCTYPE_VOTE_DATA, MBC_DOCTYPE_HISTORY_DATA } = require('../../hint');
...
const DOCTYPE_HISTORY_DATA = MBC_DOCTYPE_HISTORY_DATA;
...
class HistoryDocument extends Document {
    constructor(info, owner, name, account, date, usage, app) {
        super(MBC_DOCTYPE_HISTORY_DATA, info, owner);
