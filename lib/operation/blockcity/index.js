...
const { DOCTYPE_USER_DATA, DOCTYPE_LAND_DATA, DOCTYPE_VOTE_DATA, DOCTYPE_HISTORY_DATA, UserDocument, LandDocument, VoteDocument } = require('./document');
...
module.exports = {
    ...
    DOCTYPE_USER_DATA, DOCTYPE_LAND_DATA, DOCTYPE_VOTE_DATA, DOCTYPE_HISTORY_DATA,
