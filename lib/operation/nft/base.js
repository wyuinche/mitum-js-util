...
// hint
const { MNFT_COLLECTION_REGISTER_FORM, MNFT_SIGNER, MNFT_MINT_FORM, MNFT_NFT_ID, MNFT_SIGNERS } = require("../../hint");
...
class CollectionRegisterForm {
    constructor(target, symbol, name, royalty, uri) {
    ...
    buffer() {
        ...
        return Buffer.concat([bTarget, bSymbol, bName, bRoyalty, bUri]);
    }
