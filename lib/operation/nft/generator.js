...
class NFTGenerator extends OperationGenerator {
    ...
    /**
     * Returns CollectionRegisterForm generated from target contract account, symbol, name, royalty, uri, and whitelist.
    ...
    collectionRegisterForm(target, symbol, name, royalty, uri, whites) {
        return new CollectionRegisterForm(
            target,
            symbol,
            name,
            royalty,
    ...
    /**
     * Returns CollectionPolicy generated from name, royalty, uri and whitelist.
     * @param {string} name Collection name
     * @param {number} royalty Royalty
     * @param {string} uri Collection URI
     * @param {object} whites Whitelist
     * @returns {CollectionPolicy} CollectionPolicy
     */
    collectionPolicy(name, royalty, uri, whites) {
    ...
    /**
     * Returns CollectionPolicyUpdaterFact generated from sender, collection symbol, collection policy, and currency id.
     * @param {string} sender Sender
     * @param {string} collection Collection Symbol
     * @param {CollectionPolicy} policy Collection Policy
     * @param {string} cid Currency ID
     * @returns {CollectionPolicyUpdaterFact} CollectionPolicyUpdaterFact
     */
    getCollectionPolicyUpdaterFact(sender, collection, policy, cid) {
        return new CollectionPolicyUpdaterFact(sender, collection, policy, cid);
    }
