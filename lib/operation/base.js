...
class Item {
    ...
    buffer() {
        throw new NotImplementedError(`buffer() :: Item; Not yet implemented.`);
    }

    dict() {
        throw new NotImplementedError(`dict() :: Item; Not yet implemented.`);
    }
}
...
class OperationFact {
    ...
    buffer() {
        throw new NotImplementedError(`buffer() :: OperationFact; Not yet implemented.`);
    }

    dict() {
        throw new NotImplementedError(`dict() :: OperationFact; Not yet implemented.`);
    }

    get operationHint() {
        throw new NotImplementedError(`operationHint() :: OperationFact; Not yet implemented.`);
    }
...
class Operation {
    ...
    buffer() {
        if (this.fact_signs.length < 1) {
            throw new Error(`fact-signs-length == ${this.fact_signs.length} :: Operation; Empty fact sign.`);
        }
