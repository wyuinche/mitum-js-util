 ...
 * FeeFiGenerator helps to generate data and json files to send to mitum network.
 * Before you use methods of FeeFiGenerator, network id should be set, first.
 * @property {string} id
 */
class FeeFiGenerator extends OperationGenerator {

    /**
     * Returns PoolRegisterFact from sender, target, initial fee, incoming currency id, outgoing currency id, and currency id.
    ...
    /**
     * Returns PoolPolicyUpdaterFact from sender, target, fee, pool id, and currency id.
     * @param {string} sender Sender
     * @param {string} target Target
    ...
    /**
     * Returns PoolDepositsFact from sender, pool, pool id, and amount.
     * @param {string} sender Sender
    ...
    /**
     * Returns PoolWithdrawFact from sender, pool, pool id, and amounts.
     * @param {string} sender Sender
     * @param {string} pool Pool
     * @param {string} poolId Pool ID
