...
class BigInteger {
    ...
    /**
     * @property
     * Returns exact number in string.
     * @return {string} - big
     */
    get rawValue() {
        return this.origin;
    ...
    /**
     * @method
     * Returns 8-length Buffer of big by little-endian.
     * @return {Buffer} - 8-length little-endian Buffer of big
     */
    buffer() {
        if (this.byteSize() > 8) {
 ...
 * @param {string} typed - Typed address/key
 * @return {object} - Parsed result # object{raw, type}
 */
