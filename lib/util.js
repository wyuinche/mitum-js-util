...
const { MC_ADDRESS, PRIVATE_KEY, PUBLIC_KEY, MBC_USER_DATA, MBC_LAND_DATA, MBC_VOTE_DATA, MBC_HISTORY_DATA } = require('./hint');
...
const parseDocumentId = (documentId) => {
    ...
    if(!(suffix == MBC_USER_DATA || suffix == MBC_LAND_DATA || suffix == MBC_VOTE_DATA || suffix == MBC_HISTORY_DATA)) {
