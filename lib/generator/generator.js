...
const { DocumentGenerator } = require('../operation/document');
const { FeeFiGenerator } = require('../operation/feefi');
const { NFTGenerator } = require("../operation/nft");
