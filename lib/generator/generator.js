...
/**
 * @class
 * Generator helps to generate data and json files to send to mitum network.
 * Before you use methods of Generator, network id should be set, first.
 * @property {string} id
 * @property {CurrencyGenerator} mc
 * @property {DocumentGenerator} md
 */
class Generator {
    ...
    constructor(id) {
        this.id = id;
        this.mc = new CurrencyGenerator(id);
        this.md = new DocumentGenerator(id);
    }
