...
const { MC_CREATE_ACCOUNTS_OP, MC_KEYUPDATER_OP, MC_TRANSFERS_OP } = require('../operation/currency/hint');
const { MBS_CREATE_DOCUMENTS_OP, MBS_CREATE_DOCUMENTS_OP_FACT, 
    MBS_SIGN_DOCUMENTS_OP, MBS_SIGN_DOCUMENTS_OP_FACT, MBS_TRANSFER_DOCUMENTS_OP, MBS_TRANSFER_DOCUMENTS_OP_FACT } = require('../operation/blocksign/hint');
        ...
        if (fact instanceof CreateAccountsFact) {
            ...
            switch (fact.type) {
                ...
                case MBS_SIGN_DOCUMENTS_OP_FACT:
                    ...
                    break;
                case MBS_TRANSFER_DOCUMENTS_OP_FACT:
